...
import sty from "./PlasmicButton.module.css"; // plasmic-import: XkuaKd-CXmfR/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__qs1HP)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__xjYq)}
                role={"img"}
              />
            ),
