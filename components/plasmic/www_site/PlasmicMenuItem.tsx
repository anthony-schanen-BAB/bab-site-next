...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: wf5AIWq7ggDx/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___9ADUf)}>
        <h3
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ti1Gm)}>
          {renderPlasmicSlot({
            defaultContents: "Enter some text",
            value: args.slot
          })}
