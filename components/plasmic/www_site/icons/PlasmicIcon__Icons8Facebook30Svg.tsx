...
export type Icons8Facebook30SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Icons8Facebook30SvgIcon(props: Icons8Facebook30SvgIconProps) {
...
export default Icons8Facebook30SvgIcon;
/* prettier-ignore-end */
