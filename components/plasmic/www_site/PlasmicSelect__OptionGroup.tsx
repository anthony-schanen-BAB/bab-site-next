...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: T9jFdir3XPgD/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 0-8LFTczpILE/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__uBay2)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__rmoKz)}
              />
            </React.Fragment>
          ),
          value: args.children
