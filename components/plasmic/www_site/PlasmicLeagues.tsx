...
import sty from "./PlasmicLeagues.module.css"; // plasmic-import: PYEp7wrN6Rzc/css

createPlasmicElementProxy;

export type PlasmicLeagues__VariantMembers = {};
export type PlasmicLeagues__VariantsArgs = {};
type VariantPropType = keyof PlasmicLeagues__VariantsArgs;
export const PlasmicLeagues__VariantProps = new Array<VariantPropType>();

export type PlasmicLeagues__ArgsType = {};
type ArgPropType = keyof PlasmicLeagues__ArgsType;
export const PlasmicLeagues__ArgProps = new Array<ArgPropType>();

export type PlasmicLeagues__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultLeaguesProps {}
...
function PlasmicLeagues__RenderFunc(props: {
  variants: PlasmicLeagues__VariantsArgs;
  args: PlasmicLeagues__ArgsType;
  overrides: PlasmicLeagues__OverridesType;
  forNode?: string;
}) {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    query: usePlasmicDataOp(() => {
      return {
        ...
        opId: "85a348c6-63eb-42d6-bfcc-0bde2a158ccc",
        userArgs: {},
        cacheKey: `plasmic.$.85a348c6-63eb-42d6-bfcc-0bde2a158ccc.$.`,
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__v4IaO)}>
            <VerticalMenu
            ...
            <div className={classNames(projectcss.all, sty.freeBox__lJtsI)}>
              <div
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicLeagues__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicLeagues__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicLeagues__ArgProps,
          internalVariantPropNames: PlasmicLeagues__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicLeagues__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicLeagues";
  } else {
    func.displayName = `PlasmicLeagues.${nodeName}`;
  }
  return func;
}

export const PlasmicLeagues = Object.assign(
  // Top-level PlasmicLeagues renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicLeagues
    internalVariantProps: PlasmicLeagues__VariantProps,
    internalArgProps: PlasmicLeagues__ArgProps,
