...
import sty from "./PlasmicMenuSection.module.css"; // plasmic-import: nrOU8hQO8wWv/css
...
export const PlasmicMenuSection__ArgProps = new Array<ArgPropType>("children");
