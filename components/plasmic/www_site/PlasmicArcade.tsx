...
import HeroArcade from "../../HeroArcade"; // plasmic-import: Zg6uQ_-WnapZ/component
...
import sty from "./PlasmicArcade.module.css"; // plasmic-import: e2hVmZOgdNrW/css

createPlasmicElementProxy;

export type PlasmicArcade__VariantMembers = {};
export type PlasmicArcade__VariantsArgs = {};
type VariantPropType = keyof PlasmicArcade__VariantsArgs;
export const PlasmicArcade__VariantProps = new Array<VariantPropType>();

export type PlasmicArcade__ArgsType = {};
type ArgPropType = keyof PlasmicArcade__ArgsType;
export const PlasmicArcade__ArgProps = new Array<ArgPropType>();

export type PlasmicArcade__OverridesType = {
  root?: Flex__<"div">;
  verticalMenu?: Flex__<typeof VerticalMenu>;
  navstack?: Flex__<"div">;
  navigation?: Flex__<typeof Navigation>;
  locationPicker?: Flex__<typeof LocationPicker>;
  heroArcade?: Flex__<typeof HeroArcade>;
  tilt?: Flex__<typeof Tilt>;
  pageZoneRenderer?: Flex__<typeof PageZoneRenderer>;
  footer?: Flex__<typeof Footer>;
};

export interface DefaultArcadeProps {}
...
function PlasmicArcade__RenderFunc(props: {
  variants: PlasmicArcade__VariantsArgs;
  args: PlasmicArcade__ArgsType;
  overrides: PlasmicArcade__OverridesType;
  forNode?: string;
}) {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    query: usePlasmicDataOp(() => {
      return {
        ...
        opId: "66a529a8-1915-410a-b0bf-5ec80b84bd64",
        userArgs: {},
        cacheKey: `plasmic.$.66a529a8-1915-410a-b0bf-5ec80b84bd64.$.`,
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox___2AqXt)}>
            <VerticalMenu
            ...
            <div className={classNames(projectcss.all, sty.freeBox__drCQd)}>
              <div
              ...
              <HeroArcade
                data-plasmic-name={"heroArcade"}
                data-plasmic-override={overrides.heroArcade}
                className={classNames("__wab_instance", sty.heroArcade)}
              >
                <Tilt
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicArcade__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicArcade__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicArcade__ArgProps,
          internalVariantPropNames: PlasmicArcade__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicArcade__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicArcade";
  } else {
    func.displayName = `PlasmicArcade.${nodeName}`;
  }
  return func;
}

export const PlasmicArcade = Object.assign(
  // Top-level PlasmicArcade renders the root element
  makeNodeComponent("root"),
  {
    ...
    heroArcade: makeNodeComponent("heroArcade"),
    tilt: makeNodeComponent("tilt"),
    pageZoneRenderer: makeNodeComponent("pageZoneRenderer"),
    footer: makeNodeComponent("footer"),

    // Metadata about props expected for PlasmicArcade
    internalVariantProps: PlasmicArcade__VariantProps,
    internalArgProps: PlasmicArcade__ArgProps,
