...
import PriceCard from "../../PriceCard"; // plasmic-import: D2sOyZuiRvbV/component
...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: C2sDdrvEHTJQ/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__e3Q3X)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___9NJpj)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__qdAx5)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__bbWxb)}>
          <div className={classNames(projectcss.all, sty.freeBox__tfqZw)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard___2M3Yc)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__p8Zuo)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__k2253)}
          />
        </div>
      </Stack__>
    </div>
