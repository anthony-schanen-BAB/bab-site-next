...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: Yc2jrP4M5Icc/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__zCCs)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__mvZv)}>
            <h5
